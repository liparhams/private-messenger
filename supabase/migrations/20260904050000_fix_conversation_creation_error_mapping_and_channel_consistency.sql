CREATE OR REPLACE FUNCTION public.create_conversation(p_kind text, p_title text, p_description text DEFAULT ''::text, p_is_public boolean DEFAULT false, p_username text DEFAULT NULL::text)
RETURNS uuid
LANGUAGE plpgsql
SECURITY DEFINER
...
REVOKE EXECUTE ON FUNCTION public.create_conversation(text,text,text,boolean,text) FROM anon;
