-- Fix for username-only signup
-- Run once on existing databases created from older schema versions.
...
-- Keep profile creation safe when contact fields are omitted.
